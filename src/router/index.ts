...
const router = createRouter({
  /**
   * the error shows up because my "module" option is set to
   * ES6 which does not support the import.meta method, if I
   * want the red squiggly lines to disappear, I need to set
   * the module to a ES version which supports this
   ...
   * "env.d.ts" in the include property in tsconfig.json,
   * this issue should not appear again because I copy this
   * from a fresh proj but with typescript support.
   */
